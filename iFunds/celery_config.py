...
beat_schedule = {
    'add-every-31-seconds': {
        ...
        'schedule': crontab(hour=17, minute=17, day_of_week=6),  # 10.0
        'args': None
    },
    # 'add-every-30-seconds': {
    #     'task': 'iFunds.tasks.update_fund_data',
    #     'schedule': timedelta(seconds=10),  # 每10.0S一次
    #     'args': ([["320007", "379020", "260108", "161725"]])
    # },
    # 'update_sale': {
    #     'task': 'iFunds.tasks.deal_sale_record',
    #     'schedule': timedelta(seconds=10),  # 10.0
    #     'args': None
    # },
    # 'update_buy': {
    #     'task': 'iFunds.tasks.deal_buy_record',
    #     'schedule': timedelta(seconds=10),  # 10.0
    #     'args': None
    # },
}
